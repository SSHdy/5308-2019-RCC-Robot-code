...
Drive::Drive() : Subsystem("ExampleSubsystem")
{
  ...
  scg_left = std::make_shared(new frc::SpeedControllerGroup(*csm_left_frot,*csm_left_midd,*csm_rght_back));
  scg_rght = std::make_shared(new frc::SpeedControllerGroup(*csm_rght_frot,*csm_rght_midd,*csm_rght_back));
